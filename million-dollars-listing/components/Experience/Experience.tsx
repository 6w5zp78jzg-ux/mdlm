      ...
      >
        <Suspense fallback={null}>
          <ScrollControls pages={8} damping={0.15}>
            ...
            {/* Capa 3D — vive dentro del canvas */}
            <VideoBackground url="/hero.mp4" />
            <ScrollIndicator />

            {/* Capa HTML — portal DOM dentro del scroll */}
            <Scroll html>
              <div style={{ width: "100vw" }}>

                <HoverInfographic page={1} align="left">
                  <span className="text-white/60 uppercase tracking-[0.5em] text-[10px] mb-4 block italic font-medium">
                    Especificaciones
                  </span>
                  <h2 className="font-serif text-white text-4xl md:text-6xl font-light tracking-wide mb-6">
                    12.000 m&sup2; <br />
                    <span className="text-white/70 text-3xl md:text-5xl font-sans font-thin tracking-tighter">
                      Parcela Privada
                    </span>
                  </h2>
